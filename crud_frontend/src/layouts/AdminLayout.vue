...
<template>
  <div id="admin-layout">
    ...
    <aside class="sidebar">
      ...
      <h2 class="sidebar-title">Bibliotecário</h2>
      <ul class="sidebar-menu">
        ...
        <li :class="{ active: $route.name === 'BookForm' }">
          <router-link to="/admin/livros/new">
            <i class="fas fa-book"></i>
            <span>Cadastro</span>
          </router-link>
        </li>
        <li :class="{ active: $route.name === 'AccessRequests' }">
          <router-link to="/admin/solicitacoes">
            <i class="fas fa-user-check"></i>
            <span>Solicitações</span>
          </router-link>
        </li>
        <li :class="{ active: $route.name === 'AdminAcervo' }">
          <router-link to="/admin/acervo">
